...
#define BG_MOSAIC_ENABLE    (1<<6)
#define BG_MOSAIC_DISABLE   (0<<6)
...
#define REG_BG2X (*(volatile unsigned short *)0x4000028)
#define REG_BG2Y (*(volatile unsigned short *)0x400002C)

#define REG_BG3X (*(volatile unsigned short *)0x4000038)
#define REG_BG3Y (*(volatile unsigned short *)0x400003C)
...
#define BUTTON_PRESSED_GAME(key) (!(~(gameOldButtons)&(key)) && (~gameButtons & (key)))
#define BUTTON_RELEASED_GAME(key) ((~(gameOldButtons)&(key)) && !(~gameButtons & (key)))
